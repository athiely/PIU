...
export default function Listar() {
    ...
    const [lista, setLista] = useState([])
        ...
        const handleSubmit = (e) => {
            ...
            //tarefa agora passa a ser um objeto. Com isso adicionamos o status e o seu id (função para gerar aleatória)
            const novaTarefa = {
        ...
        const handleMove = (id, direcao) => {
            ...
            //o método findIndex retorna o index do elemento que satisfaz alguma condição. Aqui estamos utilizando para
